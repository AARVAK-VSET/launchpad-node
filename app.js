...
app.get('/account/2fa/setup', passportConfig.isAuthenticated, userController.getTwoFactorSetup);
app.post('/account/2fa/setup', passportConfig.isAuthenticated, userController.postTwoFactorSetup);
app.post('/account/2fa/disable', passportConfig.isAuthenticated, userController.postTwoFactorDisable);
app.get('/account/2fa/challenge', userController.getTwoFactorChallenge);
app.post('/account/2fa/challenge', userController.postTwoFactorChallenge);
...
app.post('/api/paypal/webhook', apiController.postPayPalWebhook);
